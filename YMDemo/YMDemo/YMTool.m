...
+ (instancetype)sharedYMTool{
    static YMTool *ymTool;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        ymTool = [[YMTool alloc] init];
    });
    return ymTool;
}
...
- (void)ym_wxLoginResult:(void(^)(UMSocialUserInfoResponse *resp))loginResult{
    [self getUserInfoForPlatform:UMSocialPlatformType_WechatSession | UMSocialPlatformType_WechatTimeLine | UMSocialPlatformType_WechatFavorite loginResult:loginResult];
}
...
#pragma mark - 各种分享类型
- (void)getUserInfoForPlatform:(UMSocialPlatformType)platformType loginResult:(void(^)(UMSocialUserInfoResponse *resp))loginResult
{
